            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <div id=" example3_wrapper"  class=" dataTables_wrapper no-footer">
                        <div >
                     <form action="{{route('search.positions')}}" method="get">

                         <a  class="btn btn-rounded btn-info" style=" margin-top: 4em;margin-right: 2em  " href="{{route('positions.create')}}">
                        ...
                        <table id="example"  style="font-size:16px "  class="display table-responsive-md dataTable" role="grid" aria-describedby="example_info">
                            ...
                            <th class="text-center align-middle">عنوان سمت</th>
        ...
        function deleteItem(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax(
                        {
                            url: 'http://127.0.0.1:8000/admin/positions/' + id,
                            type: 'delete',
                            dataType: "JSON",
                            data: {
                                _token:"{{csrf_token()}}",
                            ...
                            success: function (response)
                            {
                                if(response==false){
                                    Swal.fire(
                                        'شرکت حذف نشد',
                                        'سمت مورد نظر در جداول دیگر استفاده شده است',
                                        'باشه'
                                    );}
                                else{
